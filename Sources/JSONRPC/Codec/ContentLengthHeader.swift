...
final class ContentLengthHeaderCodec: MessageToByteEncoder, ByteToMessageDecoder {
    ...
    // Finishes a header block, most of the time that's very straightforward but we need to verify a few
    // things here.
    private func processHeaderBlockEnd(context: ChannelHandlerContext) throws -> DecodingState {
